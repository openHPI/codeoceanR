...
maxlen=95
  ...
  ll1 <- length(l1)
  ll2 <- length(l2)
  if(ll1!=1) return(rt_warn(en="Found ",ll1,en=" instances of",de=" mal"," '# ",m1,"' in ",name,de=" gefunden","."))
  if(ll2!=1) return(rt_warn(en="Found ",ll2,en=" instances of",de=" mal"," '# ",m2,"' in ",name,de=" gefunden","."))
  if(l2 < l1)return(rt_warn("'# ",m2,en="' must come after '# ",m1,"' in ",name,"."))
  #
